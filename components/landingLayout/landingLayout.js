            ...
            <div className={landingLayoutStyle.leftImageContainer}>
                <div className={landingLayoutStyle.greetingsContainer}>
                    ...
                    <div className={landingLayoutStyle.buttonContainer}>
                        <ButtonLayout buttonStylesAndInfo={{buttonText: "E-Books Library", buttonTextCode: "ebooks", backgroundColor: "#FF500A", color: "white"}} handleButtonClick={handleButtonClick} />
                        <ButtonLayout buttonStylesAndInfo={{buttonText: "E-Learn Portal", buttonTextCode: "elearn", backgroundColor: "#FF500A", color: "white", buttonAdditionalStyle: "margin-left: 1rem"}} handleButtonClick={handleButtonClick} />
                    </div>
                </div>
            </div>
